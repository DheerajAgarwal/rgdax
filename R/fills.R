...
#' @param product_id Optional character value for the currency pair. The default is \code{"all"}. This param is case insensitive and must be either \code{"all"} or one of the valid currency-pair. The list of valid currency-pairs can be fetched using \code{\link{public_info}}.
#'
