...
api.key <- "fb2a8f75e28b4829b3140aa7434f50"
secret <- "AYEsoQzsZfP1FbWmn880DFhRdQLy6TTcEZTV9ACUyD1zYJmmhDpmqKvqZnGAmOzi7EQl1c2hTVdvRP1TmszBxg=="
passphrase <- "o56boopzlw"
req.url = "/accounts/"
method = "GET"


# function definition ----
auth_new <- function(method,
                 req.url,
                 api.key,
                 secret,
                 passphrase,
