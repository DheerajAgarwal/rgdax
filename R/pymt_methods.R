...
#' @name pymt_methods
#'
#' @description This is an auth based function. User must have valid api keys generated by CoinbasePro which must be passed as mandatory arguments. These keys must have the appropriate access. Note that for this function to work, the API key must have transfer access.
#'
