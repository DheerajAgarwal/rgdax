...
#' @name account_hist
#'
#' @description This is an auth based function. The function takes a currency as an input and returns the ledger for that currency. Since currency and account id have one to one mapping, the currency is being used a proxy.
#'
